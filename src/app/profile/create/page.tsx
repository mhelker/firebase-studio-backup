...
export default function CreatePerformerProfilePage() {
  ...
  const handleFileSelect = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      form.setValue("imageUrl", "", { shouldValidate: true }); // Clear the AI URL if a file is selected
    }
  };
  ...
  async function onSubmit(data: ProfileFormValues) {
    ...
    try {
      ...
      const performerData = {
        ...
        isActive: true, // Set isActive to true on creation
      };
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Button
                      type="button"
                      variant="outline"
                      onClick={() => fileInput_ref.current?.click()}
