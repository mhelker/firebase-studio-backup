...
export default function ProfilePage() {
  // The imageUrl is now sourced from the global AuthContext
    ...
    const fetchProfiles = async () => {
      ...
      try {
        ...
        if (customerSnap.exists()) {
          ...
          // If customer doc doesn't exist, create a fallback (though it should exist from signup)
          setCustomerProfile({
             id: user.uid,
  ...
  const handleDeleteRequest = () => {
    logOut();
    toast({
        title: "Account Deletion Process Initiated",
        description: "You have been logged out. For full account deletion, please contact support at support@talenthop.com. (This is a demo action)",
        duration: 8000,
    });
  }
             ...
             <div className="p-4 border rounded-md bg-secondary/20 space-y-4">
                <div className="flex items-center gap-4">
                    <Avatar className="h-16 w-16 text-2xl">
                        {/* The Avatar now uses the global imageUrl from the auth context */}
            ...
            {isFetchingProfile ? (
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-4 p-4 border rounded-md bg-secondary/20">
                        <Avatar className="h-16 w-16 text-2xl">
                            {/* The performer avatar also uses the global imageUrl */}
